...
const Home = () => {
  return (
    <div className="h-32 sm:h-64  md:h-64 lg:h-[30rem] ">
      <Carousel slideInterval={5000} pauseOnHover indicators={false}
      leftControl={<IoIosArrowDropleftCircle className='text-green-600 scale-[2] md:scale-[3]' />} 
      rightControl={<IoIosArrowDroprightCircle className='text-green-600 scale-[2] md:scale-[3]' />}>
